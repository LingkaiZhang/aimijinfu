...
public class StickyNavLayout extends LinearLayout {
    ...
    protected void onFinishInflate() {
        ...
        mNav = findViewById(R.id.mIndicator);
        View view = findViewById(R.id.vpProductDetail);
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (Math.abs(dy) > mTouchSlop) {
                    ...
                    if (mInnerScrollView instanceof ScrollView) {
                        ...
                        if ((!isTopHidden && getScrollY() == 0 && dy < 0) || (!isTopHidden && getScrollY() != 0)
                                || (c != null
                                && c.getTop() == 0
                                && isTopHidden && dy > 0) || (c == null
                                && isTopHidden && dy > 0)) {
