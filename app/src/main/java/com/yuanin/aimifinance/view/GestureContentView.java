...
public class GestureContentView extends ViewGroup {
    ...
    public GestureContentView(Context context, boolean isVerify,
        ...
        blockWidth = (screenDispaly[0] - StaticMembers.GESTURE_WIDTH_GAP) / 3;
    ...
    private void addChild() {
        for (int i = 0; i < 9; i++) {
            ...
            image.setBackgroundDrawable(new BitmapDrawable(context.getResources(),
                    AppUtils.getBitmap(context, R.mipmap.gesture_node_normal)));
//            image.setImageResource(R.mipmap.gesture_node_normal);
    ...
    public void setParentView(ViewGroup parent) {
        ...
        LayoutParams layoutParams = new LayoutParams(width - StaticMembers.GESTURE_WIDTH_GAP, width - StaticMembers.GESTURE_HEIGHT_GAP);
