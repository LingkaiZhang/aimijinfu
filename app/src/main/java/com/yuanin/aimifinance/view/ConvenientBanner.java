...
import com.yuanin.aimifinance.adapter.CBPageAdapter;
import com.yuanin.aimifinance.inter.CBViewHolderCreator;
import com.yuanin.aimifinance.listener.CBPageChangeListener;
...
public class ConvenientBanner<T> extends LinearLayout {
    ...
    public ConvenientBanner setPages(CBViewHolderCreator holderCreator, List<T> datas) {
        this.mDatas = datas;
        CBPageAdapter pageAdapter = new CBPageAdapter(holderCreator, mDatas);
