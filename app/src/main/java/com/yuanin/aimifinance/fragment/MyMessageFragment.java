...
public class MyMessageFragment extends BaseFragment implements XListView.IXListViewListener{

    @ViewInject(R.id.lvMyMessage)
    private XListView lvMyMessage;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        isPrepared = true;
        lvMyMessage.setPullRefreshEnable(true);
        lvMyMessage.setPullLoadEnable(true);
        lvMyMessage.setXListViewListener(this);
        requestData();
        return view;
    }
    ...
    private void loadComplete() {
        lvMyMessage.stopRefresh();
        lvMyMessage.stopLoadMore();
        lvMyMessage.setRefreshTime(new SimpleDateFormat(StaticMembers.DATE_FORMAT_STR, Locale.CHINA).format(new Date()));
    }
