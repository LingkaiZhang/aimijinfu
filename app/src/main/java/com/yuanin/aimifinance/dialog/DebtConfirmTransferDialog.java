 ...
 * @desc 通用dialog
 */
public class DebtConfirmTransferDialog {
    ...
    public DebtConfirmTransferDialog(Context context, boolean isCancelable, String title,
        ...
        view = LayoutInflater.from(context).inflate(R.layout.dialog_debt_transfer_comfirm, null);
