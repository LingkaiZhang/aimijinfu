...
public class NoticeListActivity extends BaseListActivity {
    ...
    private Context context = NoticeListActivity.this;
    // 页码
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        x.view().inject(this);
        initTopBar(getResources().getString(R.string.title_notice), toptitleView, true);
                        ...
                        if (entity.isSuccess(context)) {
                            if (entity.isNotNull()) {
                                if (mList == null) {
                                    ...
                                    mAdp = new NoticeListAdapter(mList, context);
