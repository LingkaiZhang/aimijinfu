...
import com.yuanin.aimifinance.fragment.MyMessageFragment;
import com.yuanin.aimifinance.fragment.SystemNoticeFragment;
...
public class MessageCenterActivity extends BaseFragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        x.view().inject(this);
        initTopBar("消息中心", toptitleView, true);
        if (textViews == null) {
            textViews = new ArrayList<TextView>();
        }
        textViews.add(tvSystemNotice);
        textViews.add(tvMyMessage);
        InitImageView();
        initViewPager();
    }

    @Event(value = {R.id.llSystemNotice, R.id.llMyMessage, R.id.btnRefresh})
    ...
    public class MyOnPageChangeListener implements ViewPager.OnPageChangeListener {
        ...
        public void onPageSelected(int arg0) {
            ...
            ViewPagerUtils.changeTextViewStyle_FINANCE(MessageCenterActivity.this, arg0, textViews);
        }
